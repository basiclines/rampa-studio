 ...
 * @example
 * ```ts
 * const r = contrast('#777', '#fff');                 // APCA default
 * const r = contrast('#fff', '#1e1e2e').mode('wcag'); // WCAG 2.x
 ...
 * @example
 * ```ts
 * const result = contrast('#777', '#fff');                    // APCA (default)
 * const result = contrast('#ffffff', '#1e1e2e').mode('wcag'); // WCAG 2.x
 * ```
 */
