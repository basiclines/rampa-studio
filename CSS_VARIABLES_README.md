# CSS Variables Feature Documentation

## Overview

This feature automatically generates CSS variables from your color ramps and provides autocomplete suggestions in the Monaco Editor. When you create, edit, or modify color ramps, CSS variables are generated behind the scenes and made available for use in your CSS code.
...
3. Monaco Editor will show autocomplete suggestions with your color ramp variables
...
- **`UpdateMonacoCompletions.ts`**: Provides Monaco Editor autocomplete integration
...
- **Monaco Integration**: Full autocomplete support with documentation tooltips
...
- Monaco completions are updated efficiently
